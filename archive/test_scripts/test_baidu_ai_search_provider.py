#!/usr/bin/env python3
"""Test Baidu AI Search Provider implementation."""
...
from infra.tool_clients.providers.baidu_ai_search_provider import BaiduAISearchProvider

# Set API key
os.environ["BAIDU_QIANFAN_API_KEY"] = "REDACTED"

print("="*80)
print("测试 BaiduAISearchProvider")
print("="*80)
